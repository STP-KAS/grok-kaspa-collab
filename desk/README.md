# Desk — dual-rail invoice

Self-hosted till. **Price in EUR.** Settle with a SEPA (EPC) QR, cash, or a `kaspa:` QR. You mark it paid. CSV for the accountant.
...
go build -o desk.exe .
$env:DESK_NAME="Desk"
$env:DESK_IBAN="DE89370400440532013000"   # example IBAN; put yours
# $env:DESK_KASPA="q..."
